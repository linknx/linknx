...
public:
    ...
    {
        setField(Minute, min, true);
    }
    int getWeekdays() const
    {
        return weekdays_m;
    }
    void setWeekdays(int wd)
    {
        weekdays_m = wd;
    }
...
public:
    ...
    int getOffsetInSeconds() const
    {
        return offset_m;
    }
    ExceptionDays getExceptions() const
    {
        return exception_m;
    }
...
public:
    ...
    virtual time_t getExecTime()
    {
        return nextExecTime_m;
    };
    virtual void statusXml(ticpp::Element *pStatus);

    void setAt(TimeSpec *at)
    {
        at_m = at;
    };
    void setUntil(TimeSpec *until)
    {
        until_m = until;
    };
