...
public:
    ...
    {
        return &emailGateway_m;
    };
    TimerManager *getTimerManager()
    {
        return &timers_m;
    };
    ExceptionDays *getExceptionDays()
    {
        return &exceptionDays_m;
    };
    PersistentStorage *getPersistentStorage()
    {
        return persistentStorage_m;
    };
    LocationInfo *getLocationInfo()
    {
        return &locationInfo_m;
    };
    void setConfigFile(const char *filename)
    {
        if (filename)
            configFile_m = filename;
    };
