...
protected:
    ...
    public:
        template <class T>
        BufferBuilder &operator<<(const T &value)
        {
...
public:
    ...
    const char *getDescr()
    {
        return descr_m.c_str();
    };
    const eibaddr_t getGad()
    {
        return gad_m;
    };
    const eibaddr_t getReadRequestGad()
    {
        return readRequestGad_m;
    };
    std::list<eibaddr_t>::iterator getListenerGad()
    {
        return listenerGadList_m.begin();
    };
    std::list<eibaddr_t>::iterator getListenerGadEnd()
    {
        return listenerGadList_m.end();
    };
    //    eibaddr_t getListenerGad(int idx) { return listenerGadList_m[idx]; };
    const eibaddr_t getLastTx()
    {
        return lastTx_m;
    };
    void read();
    ...
    bool forceUpdate()
    {
        return (!init_m || (flags_m & Stateless));
    };
...
public:
    ...
    {
        get();
        return TObjectValue::value_m;
    };

protected:
    virtual bool set(bool value)
    {
        return TObjectValue::set(value);
    };
    ...
    virtual bool getBoolObjectValue()
    {
        return TObjectValue::value_m;
    };
    virtual ObjectValue *getObjectValue()
    {
        return static_cast<TObjectValue *>(this);
    };
    static Logger &logger_m;
};
...
public:
    ...
    SwitchingObjectValue(bool value)
        : value_m(value) {};
    ...
    virtual std::string getValueString(bool value)
    {
        return value ? "on" : "off";
    };

protected:
    SwitchingObjectValue()
        : value_m(false) {};
    virtual bool set(bool value);
    virtual bool set(ObjectValue *value);
    virtual bool set(double value);
...
static const SwitchingType SwitchingTypes[] = { { "1.xxx", "1", "0" },
    { "1.001", "on", "off" },
    { "1.002", "true", "false" },
...
public:
    SwitchingImplObjectValue(const std::string &value)
    {
        init(value);
    };
    SwitchingImplObjectValue(bool value)
        : SwitchingObjectValue(value) {};
    virtual ~SwitchingImplObjectValue() {};
    virtual std::string getType()
    {
        return SwitchingTypes[eis].type;
    };
    virtual std::string getValueString(bool value)
    {
        return value ? SwitchingTypes[eis].valueTrue : SwitchingTypes[eis].valueFalse;
    };
};
...
public:
    SwitchingControlObject()
        : TObjectValue(false, false) {};
    ...
    {
        get();
        return TObjectValue::control_m;
    };

protected:
    virtual bool set(bool value, bool control)
    {
        return TObjectValue::set(value, control);
    };
    virtual bool set(ObjectValue *value)
    {
        return TObjectValue::set(value);
...
public:
    ...
    SwitchingControlObjectValue(bool value, bool control)
        : value_m(value)
        , control_m(control) {};
...
static const SwitchingControlType SwitchingControlTypes[] = { { "2.xxx", "1", "0" },
    { "2.001", "on", "off" },
    { "2.002", "true", "false" },
...
public:
    SwitchingControlImplObjectValue(const std::string &value)
    {
        init(value);
    };
    SwitchingControlImplObjectValue(bool value, bool control)
        : SwitchingControlObjectValue(value, control) {};
    virtual ~SwitchingControlImplObjectValue() {};
    virtual std::string getType()
    {
        return SwitchingControlTypes[eis].type;
    };
    virtual std::string getValueString(bool value)
    {
        return value ? SwitchingControlTypes[eis].valueTrue : SwitchingControlTypes[eis].valueFalse;
    };
};
...
protected:
    ...
    StepDirObjectValue()
        : direction_m(0)
        , stepcode_m(0) {};
    StepDirObjectValue(int direction, int stepcode)
...
protected:
    DimmingObjectValue(int direction, int stepcode)
        : StepDirObjectValue(direction, stepcode) {};
};

class DimmingObject : public StepDirObject, public DimmingObjectValue {
public:
    DimmingObject()
        : DimmingObjectValue(0, 0) {};
...
protected:
    virtual bool set(ObjectValue *value)
    {
        return DimmingObjectValue::set(value);
    };
    virtual bool set(double value)
    {
        return DimmingObjectValue::set(value);
    ...
    virtual bool setStep(int direction, int stepcode)
    {
...
protected:
    BlindsObjectValue(int direction, int stepcode)
        : StepDirObjectValue(direction, stepcode) {};
};
...
protected:
    virtual bool set(ObjectValue *value)
    {
        return BlindsObjectValue::set(value);
    };
    virtual bool set(double value)
    {
        return BlindsObjectValue::set(value);
...
protected:
    ...
    TimeObjectValue(int wday, int hour, int min, int sec)
        : wday_m(wday)
        , hour_m(hour)
        , min_m(min)
        , sec_m(sec) {};
...
protected:
    virtual bool set(ObjectValue *value)
    {
        return TimeObjectValue::set(value);
    };
    virtual bool set(double value)
    {
        return TimeObjectValue::set(value);
...
protected:
    ...
    DateObjectValue(int day, int month, int year)
        : day_m(day)
        , month_m(month)
        , year_m(year) {};
};
...
protected:
    virtual bool set(ObjectValue *value)
    {
        return DateObjectValue::set(value);
    };
    virtual bool set(double value)
    {
        return DateObjectValue::set(value);
...
static const FloatValueType FloatValueTypes[] = { { "9.xxx", -671088.64, 670760.96 },
    { "9.001", -273, 670760 },
    { "9.002", -670760, 670760 },
    { "9.003", -670760, 670760 },
    { "9.004", 0, 670760 },
...
public:
    ValueImplObjectValue(const std::string &value)
    {
        init(value);
    };
    ValueImplObjectValue(double value)
        : ValueObjectValue(value) {};
    virtual ~ValueImplObjectValue() {};
    virtual std::string getType()
    {
        return FloatValueTypes[subtype].type;
    };
    virtual double getBound(bool upper)
    {
        return upper ? FloatValueTypes[subtype].valueMax : FloatValueTypes[subtype].valueMin;
    };
};
...
public:
    ...
    virtual double getBound(bool upper)
    {
        return upper ? DBL_MAX : DBL_MIN;
    };

protected:
    ValueObject32Value(double value)
        : ValueObjectValue(value) {};
    ValueObject32Value() {};
};
...
protected:
    virtual bool set(ObjectValue *value)
    {
        return ValueObject32Value::set(value);
    };
    virtual bool set(double value)
    {
        return ValueObject32Value::set(value);
...
protected:
    virtual bool set(ObjectValue *value);
    uint32_t value_m;
    UIntObjectValue(uint32_t value)
        : value_m(value) {};
    UIntObjectValue()
        : value_m(0) {};
};
...
protected:
    ...
    virtual bool set(double value)
    {
        return setInt(static_cast<uint32_t>(value));
    };
...
protected:
    U8ObjectValue(uint32_t value)
        : UIntObjectValue(value) {};
    U8ObjectValue() {};
};
...
public:
    ...
    virtual std::string toString()
    {
        return U8ObjectValue::toString();
    };

protected:
    virtual bool set(ObjectValue *value)
    {
        return U8ObjectValue::set(value);
    };
    virtual bool setInt(uint32_t value)
    {
        if (value_m != value) {
            value_m = value;
            return true;
...
protected:
    ScalingObjectValue(uint32_t value)
        : U8ObjectValue(value) {};
};
...
public:
    ...
    virtual std::string toString()
    {
        return ScalingObjectValue::toString();
    };

protected:
    virtual bool set(ObjectValue *value)
    {
        return ScalingObjectValue::set(value);
    };
    virtual bool setInt(uint32_t value)
    {
        if (value_m != value) {
...
protected:
    AngleObjectValue(uint32_t value)
        : U8ObjectValue(value) {};
};
...
public:
    ...
    virtual std::string toString()
    {
        return AngleObjectValue::toString();
    };

protected:
    virtual bool set(ObjectValue *value)
    {
        return AngleObjectValue::set(value);
    };
    virtual bool setInt(uint32_t value)
    {
        if (value_m != value) {
...
protected:
    ...
    HeatingModeObjectValue(uint32_t value)
        : U8ObjectValue(value) {};
};
...
public:
    ...
    virtual std::string toString()
    {
        return HeatingModeObjectValue::toString();
    };

protected:
    virtual bool set(ObjectValue *value)
    {
        return HeatingModeObjectValue::set(value);
    };
    virtual bool setInt(uint32_t value)
    {
        if (value_m != value) {
...
protected:
    Latin1CharObjectValue(uint32_t value)
        : U8ObjectValue(value) {};
};
...
protected:
    AsciiCharObjectValue(uint32_t value)
        : U8ObjectValue(value) {};
};
...
public:
    ...
    virtual std::string toString()
    {
        return Latin1CharObjectValue::toString();
    };

protected:
    virtual bool set(ObjectValue *value)
    {
        return Latin1CharObjectValue::set(value);
    };
    virtual bool setInt(uint32_t value)
    {
        if (value_m != value) {
    ...
    virtual ObjectValue *getObjectValue()
    {
        return static_cast<Latin1CharObjectValue *>(this);
    };
    virtual uint32_t getInt()
    {
        return value_m;
...
public:
    ...
    virtual std::string toString()
    {
        return AsciiCharObjectValue::toString();
    };

protected:
    virtual bool set(ObjectValue *value)
    {
        return AsciiCharObjectValue::set(value);
    };
    virtual bool setInt(uint32_t value)
    {
        if (value_m != value) {
    ...
    virtual ObjectValue *getObjectValue()
    {
        return static_cast<AsciiCharObjectValue *>(this);
    };
    virtual uint32_t getInt()
    {
        return value_m;
...
public:
    ...
    virtual std::string toString()
    {
        return U16ObjectValue::toString();
    };

protected:
    virtual bool set(ObjectValue *value)
    {
        return U16ObjectValue::set(value);
    };
    virtual bool setInt(uint32_t value)
    {
        if (value_m != value) {
...
public:
    ...
    virtual std::string toString()
    {
        return U32ObjectValue::toString();
    };

protected:
    virtual bool set(ObjectValue *value)
    {
        return U32ObjectValue::set(value);
    };
    virtual bool setInt(uint32_t value)
    {
        if (value_m != value) {
...
public:
    ...
    virtual std::string toString()
    {
        return RGBObjectValue::toString();
    };

protected:
    virtual bool set(ObjectValue *value)
    {
        return RGBObjectValue::set(value);
    };
    virtual bool setInt(uint32_t value)
    {
        if (value_m != value) {
    ...
    virtual ObjectValue *getObjectValue()
    {
        return static_cast<RGBObjectValue *>(this);
    };
    virtual uint32_t getInt()
    {
        return value_m;
...
protected:
    ...
    virtual bool set(double value)
    {
        return setInt(static_cast<int32_t>(value));
    };
...
protected:
    S8ObjectValue(int32_t value)
        : IntObjectValue(value) {};
    S8ObjectValue() {};
};
...
public:
    ...
    virtual std::string toString()
    {
        return S8ObjectValue::toString();
    };

protected:
    virtual bool set(ObjectValue *value)
    {
        return S8ObjectValue::set(value);
    };
    virtual bool setInt(int32_t value)
    {
        if (value_m != value) {
            value_m = value;
            return true;
...
public:
    ...
    virtual std::string toString()
    {
        return S16ObjectValue::toString();
    };

protected:
    virtual bool set(ObjectValue *value)
    {
        return S16ObjectValue::set(value);
    };
    virtual bool setInt(int32_t value)
    {
        if (value_m != value) {
...
public:
    ...
    virtual std::string toString()
    {
        return S32ObjectValue::toString();
    };

protected:
    virtual bool set(ObjectValue *value)
    {
        return S32ObjectValue::set(value);
    };
    virtual bool setInt(int32_t value)
    {
        if (value_m != value) {
...
protected:
    virtual bool set(ObjectValue *value)
    {
        return S64ObjectValue::set(value);
    };
    virtual bool set(double value)
    {
        return setInt(static_cast<int64_t>(value));
    };
    virtual ObjectValue *getObjectValue()
    {
        return static_cast<S64ObjectValue *>(this);
    };
    virtual bool setInt(int64_t value)
    {
        if (value_m != value) {
            value_m = value;
            return true;
...
protected:
    RGBWObjectValue(int64_t value)
        : S64ObjectValue(value) {};
    RGBWObjectValue() {};
};
...
public:
    ...
    virtual std::string toString()
    {
        return RGBWObjectValue::toString();
    };

protected:
    virtual bool set(ObjectValue *value)
    {
        return RGBWObjectValue::set(value);
    };
    virtual bool setInt(int64_t value)
    {
        if (RGBWObjectValue::value_m != value) {
            RGBWObjectValue::value_m = value;
            return true;
        }
        return false;
    };
    virtual ObjectValue *getObjectValue()
    {
        return static_cast<RGBWObjectValue *>(this);
    };
    virtual int64_t getInt()
    {
        return RGBWObjectValue::value_m;
    };
    static Logger &logger_m;
};
#endif
...
public:
    ...
    static std::string transcode(const std::string &source, const std::string &sourceEncoding,
...
public:
    ...
    virtual std::string toString()
    {
        return StringObjectValue::toString();
    };

protected:
    virtual bool set(ObjectValue *value)
    {
        return StringObjectValue::set(value);
    };
    virtual bool set(double value)
    {
        return StringObjectValue::set(value);
...
public:
    ...
    virtual std::string toString()
    {
        return String14ObjectValue::toString();
    };

protected:
    virtual bool set(ObjectValue *value)
    {
        return String14ObjectValue::set(value);
    };
    virtual bool set(double value)
    {
        return String14ObjectValue::set(value);
...
public:
    ...
    virtual std::string toString()
    {
        return String14AsciiObjectValue::toString();
    };

protected:
    virtual bool set(ObjectValue *value)
    {
        return String14AsciiObjectValue::set(value);
    };
    virtual bool set(double value)
    {
        return String14AsciiObjectValue::set(value);
